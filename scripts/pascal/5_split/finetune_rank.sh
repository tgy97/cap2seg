...
#Zero Label
CUDA_VISIBLE_DEVICES=$1 python train.py --config config/voc12/ZLSS.yaml --experimentid finetune_906_t0.4 --imagedataset voc12 --my_load_from logs/voc12/myexp/checkpoint_20000.pth.tar --use_caption
CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/voc12/ZLSS.yaml --imagedataset voc12 --model-path logs/voc12/finetune_906_t0.4/checkpoint_1000.pth.tar -r zlss
CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/voc12/ZLSS.yaml --imagedataset voc12 --model-path logs/voc12/finetune_906_t0.4/checkpoint_1000.pth.tar -r gzlss
CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/voc12/ZLSS.yaml --imagedataset voc12 --model-path logs/voc12/finetune_906_t0.4/checkpoint_1000.pth.tar -r gzlss --threshold 0.9
CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/voc12/ZLSS.yaml --imagedataset voc12 --model-path logs/voc12/finetune_906_t0.4/checkpoint_1000.pth.tar -r gzlss --threshold 0.99
CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/voc12/ZLSS.yaml --imagedataset voc12 --model-path logs/voc12/finetune_906_t0.4/checkpoint_1000.pth.tar -r gzlss --threshold 0.999

...
#Zero Label
#CUDA_VISIBLE_DEVICES=$1 python train.py --config config/voc12/ZLSS.yaml --experimentid finetune --imagedataset voc12 --my_load_from data/models/pascal_checkpoint_20000.pth.tar
#CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/voc12/ZLSS.yaml --imagedataset voc12 --model-path logs/voc12/finetune/checkpoint_20000.pth.tar -r zlss
#CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/voc12/ZLSS.yaml --imagedataset voc12 --model-path logs/voc12/finetune/checkpoint_20000.pth.tar -r gzlss
#CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/voc12/ZLSS.yaml --imagedataset voc12 --model-path logs/voc12/finetune/checkpoint_20000.pth.tar -r gzlss --threshold 0.6
CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/voc12/ZLSS.yaml --imagedataset voc12 --model-path logs/voc12/finetune/checkpoint_20000.pth.tar -r gzlss --threshold 0.9
CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/voc12/ZLSS.yaml --imagedataset voc12 --model-path logs/voc12/finetune/checkpoint_20000.pth.tar -r gzlss --threshold 0.99
...
CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/voc12/ZLSS.yaml --imagedataset voc12 --model-path logs/voc12/finetune/checkpoint_20000.pth.tar -r gzlss --threshold 0.999

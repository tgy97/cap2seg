...
#Zero Label
#CUDA_VISIBLE_DEVICES=$1 python train.py --config config/voc12/ZLSS.yaml --experimentid new_split --imagedataset voc12 --my_load_from data/models/pascal_checkpoint_20000.pth.tar
#CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/voc12/ZLSS.yaml --imagedataset voc12 --model-path logs/voc12/new_split/checkpoint_10000.pth.tar -r zlss
CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/voc12/ZLSS.yaml --imagedataset voc12 --model-path logs/voc12/new_split/checkpoint_3000.pth.tar -r gzlss
CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/voc12/ZLSS.yaml --imagedataset voc12 --model-path logs/voc12/new_split/checkpoint_3000.pth.tar -r gzlss --threshold 0.2
CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/voc12/ZLSS.yaml --imagedataset voc12 --model-path logs/voc12/new_split/checkpoint_3000.pth.tar -r gzlss --threshold 0.4
CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/voc12/ZLSS.yaml --imagedataset voc12 --model-path logs/voc12/new_split/checkpoint_3000.pth.tar -r gzlss --threshold 0.6
...
CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/voc12/ZLSS.yaml --imagedataset voc12 --model-path logs/voc12/new_split/checkpoint_3000.pth.tar -r gzlss --threshold 0.1

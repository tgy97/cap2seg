...
CUDA_VISIBLE_DEVICES=$1 python visual.py --config config/cocostuff/ZLSS.yaml --imagedataset cocostuff --model-path logs/cocostuff/split2_append_rank_upperbound_continue/checkpoint_20000.pth.tar -r gzlss --threshold 0.8 

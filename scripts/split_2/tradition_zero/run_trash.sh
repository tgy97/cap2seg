...
#Zero Label
CUDA_VISIBLE_DEVICES=$1 python train.py --config config/cocostuff/ZLSS.yaml --experimentid debug --imagedataset cocostuff --use_caption --my_load_from /scratch/tiangy/SPNet/logs/cocostuff/split2_exact_rank/checkpoint_10000.pth.tar

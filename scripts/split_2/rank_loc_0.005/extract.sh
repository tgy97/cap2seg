...
#Zero Label
#CUDA_VISIBLE_DEVICES=$1 python train.py --config config/cocostuff/ZLSS.yaml --experimentid split2_rank_loc_05 --imagedataset cocostuff --use_caption --my_load_from /scratch/tiangy/SPNet/logs/cocostuff/split2_rank_loc/checkpoint_10000.pth.tar
CUDA_VISIBLE_DEVICES=$1 python extract.py --config config/cocostuff/ZLSS.yaml --imagedataset cocostuff --model-path logs/cocostuff/split2_rank_loc_05/checkpoint_10000.pth.tar -r zlss
#CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/cocostuff/ZLSS.yaml --imagedataset cocostuff --model-path logs/cocostuff/split2_rank_loc_05/checkpoint_10000.pth.tar -r gzlss
#CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/cocostuff/ZLSS.yaml --imagedataset cocostuff --model-path logs/cocostuff/split2_rank_loc_05/checkpoint_10000.pth.tar -r gzlss --threshold 0.4
#CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/cocostuff/ZLSS.yaml --imagedataset cocostuff --model-path logs/cocostuff/split2_rank_loc_05/checkpoint_10000.pth.tar -r gzlss --threshold 0.5
#CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/cocostuff/ZLSS.yaml --imagedataset cocostuff --model-path logs/cocostuff/split2_rank_loc_05/checkpoint_10000.pth.tar -r gzlss --threshold 0.6
:<<!
#Few Label

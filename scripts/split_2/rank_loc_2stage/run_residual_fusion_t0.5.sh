...
#Zero Label
CUDA_VISIBLE_DEVICES=$1 python train.py --config config/cocostuff/ZLSS.yaml --experimentid split2_rank_loc_2stage_residual_fusion_t0.5 --imagedataset cocostuff --use_caption --my_load_from logs/cocostuff/split2_rank_loc_05/checkpoint_10000.pth.tar --fix_backbone 
CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/cocostuff/ZLSS.yaml --imagedataset cocostuff --model-path logs/cocostuff/split2_rank_loc_2stage_residual_fusion_t0.5/checkpoint_20000.pth.tar -r zlss
CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/cocostuff/ZLSS.yaml --imagedataset cocostuff --model-path logs/cocostuff/split2_rank_loc_2stage_residual_fusion_t0.5/checkpoint_20000.pth.tar -r gzlss
CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/cocostuff/ZLSS.yaml --imagedataset cocostuff --model-path logs/cocostuff/split2_rank_loc_2stage_residual_fusion_t0.5/checkpoint_20000.pth.tar -r gzlss --threshold 0.4

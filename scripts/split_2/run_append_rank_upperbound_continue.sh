...
#Zero Label
#CUDA_VISIBLE_DEVICES=$1 python train.py --config config/cocostuff/ZLSS.yaml --experimentid split2_append_rank_upperbound_continue --imagedataset cocostuff --use_caption --my_load_from logs/cocostuff/split2_append_rank_upperbound/checkpoint_20000.pth.tar
#CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/cocostuff/ZLSS.yaml --imagedataset cocostuff --model-path logs/cocostuff/split2_append_rank_upperbound_continue/checkpoint_20000.pth.tar -r zlss
#CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/cocostuff/ZLSS.yaml --imagedataset cocostuff --model-path logs/cocostuff/split2_append_rank_upperbound_continue/checkpoint_20000.pth.tar -r gzlss
#CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/cocostuff/ZLSS.yaml --imagedataset cocostuff --model-path logs/cocostuff/split2_append_rank_upperbound_continue/checkpoint_20000.pth.tar -r gzlss --threshold 0.4
CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/cocostuff/ZLSS.yaml --imagedataset cocostuff --model-path logs/cocostuff/split2_append_rank_upperbound_continue/checkpoint_20000.pth.tar -r gzlss --threshold 0.6
CUDA_VISIBLE_DEVICES=$1 python eval.py --config config/cocostuff/ZLSS.yaml --imagedataset cocostuff --model-path logs/cocostuff/split2_append_rank_upperbound_continue/checkpoint_20000.pth.tar -r gzlss --threshold 0.8
